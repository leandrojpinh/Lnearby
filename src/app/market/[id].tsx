...
import { Alert, Text, View, Modal, StatusBar } from "react-native";
...
export default function Market() {
  ...
  async function handleOpenCamera() {
    try {
      ...
      if (!granted) return Alert.alert("Câmera", "Você precisa habilitar o uso da câmera");
  ...
  function handleUseCoupon(id: string) {
    ...
    Alert.alert("Cupom", "Não é possível reutilizar um cupom. Deseja realmente resgatar o cupom?",
      [
